...
export type StorageHash =
  StorageHashBase<'44813b418150d7722b366f74175cabf6b38253f2d7017a7d3d7d28ec83558bb8'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Book: {
      ...
      readonly titleKey: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Book: {
      ...
      readonly titleKey: CodecTypes['pg/text@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            readonly book: {
              ...
              indexes: readonly [
                {
                  readonly name: 'book_userId_idx_a489d58a';
                  readonly prefix: 'book_userId_idx';
            ...
            readonly note: {
              ...
              indexes: readonly [
                {
                  readonly name: 'note_bookId_idx_3eec38a3';
                  readonly prefix: 'note_bookId_idx';
          ...
          readonly Book: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly titleKey: { readonly column: 'titleKey' };
